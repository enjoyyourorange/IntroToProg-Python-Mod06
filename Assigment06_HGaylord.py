...
# HGaylord,8.12.22,Created started script
# Hayden Gaylord,8.17.22,Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
while (True):
    ...
    if choice_str.strip() == '1':  # Add a new Task
        ...
        table_lst = Processor.add_data_to_list(add_task=task, add_priority=priority, list_of_rows=table_lst)
        continue  # to show the menu

    elif choice_str == '2':  # Remove an existing Task
        task = IO.input_task_to_remove()
        table_lst = Processor.remove_data_from_list(del_task=task, list_of_rows=table_lst)
        continue  # to show the menu
